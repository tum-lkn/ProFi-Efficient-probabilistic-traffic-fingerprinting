...
from markov_chain import fingerprint_mc
from markov_chain import classification_mc
...
def check_model(num_packets):
    ...
    fingerprint_mc.run_fingerprint_mc()
    assignment = classification_mc.run_classify_traffic()
...
def save_dataframe(accuracy_l, precision_l, recall_l, f1_score_l):
    ...
    csv_file = os.path.join(constants.result_path, 'model_search_results_mc.csv')
